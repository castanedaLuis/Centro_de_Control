                    ...
                    <div class="container">
                        <div class="row justify-content-center pt-5 mt-5 m-1">
                            <div class="col-md-6 col-sm-8 col-xl-4 col-lg-4 formulario">
                                <form action="../process/process_modify_category.php?id=<?php echo $row['id']; ?>" method="POST" enctype="multipart/form-data">
                                    <div class="form-group text-center pt-3">
                                        <h1 class="text-dark">Actualiza la categoría</h1>
                                    </div>
                                    ...
                                    <div class="form-group mx-sm-4 pb-5">
                                    <input  type="number" class="form-control" name="products" placeholder="Products" value="<?php echo $row['products'];  ?>" required>
                                    </div>
                                    <div class="form-group mx-sm-4 pb-5">
