    ...
    <div class="row row-cols-1 row-cols-md-2 g-4 mt-5">
            ...
            <div class="card mt-5 mx-auto" style="width: 17rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><?php echo '# - ' . $row['products']; ?></li>
                        <li class="list-group-item">A third item</li>
                    </ul>
                    <div class="card-body">
                        <button class="btn btn-primary"> <a href="../process/delete_category.php?id=<?php echo $row['id']; ?>" class="text-decoration-none text-light">Eliminar</a></button>
                        <button class="btn btn-danger"> <a href="modify_category.php?id=<?php echo $row['id']; ?>"class="text-decoration-none text-light">Modificar</a></button>
                    </div>
            </div>
            <?php
                }
