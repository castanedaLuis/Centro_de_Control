...
<body class="m-5 mt-0 row justify-content-center">
    ...
    <section class="d-flex justify-content-center">
        <div class="card col-sm-4 p-3 text-dark bg-light">
            <div class="mb-3">
                <h2 class="fw-bold">Añadir Producto</h2>
            </div>
            <div class="mb-2">
                <form  action="../process/process_loading_product.php" method="post" enctype="multipart/form-data">
                    <div class="mb-2 ">
                        <label for="Nombre"></label>
                        <input class="form-control rounded-start border border-success" required type="text" name="name" placeholder="Nombre del producto" value="">
                    </div>
                    <div class="mb-2">
                        <label for="Description"></label>
                        <textarea class="form-control rounded-start border border-success" required name="description" placeholder="Ingresa la description del producto" value="" id="" cols="60" rows="5"></textarea>
                    </div>
                    <div class="mb-2">
                        <label for="Nombre"></label>
                        <input class="form-control rounded-start border border-success" required type="number" name="category" placeholder="id - Categoria" value="">
                    </div>
                    <div class="mb-2">
                        <label for="Nombre"></label>
                        <input class="form-control rounded-start border border-success" required type="text" name="made" placeholder="Region del Producto" value="">
                    </div>
                    <div class="mb-2">
                        <label for="Nombre"></label>
                        <input class="form-control rounded-start border border-success" required type="email" name="mail" placeholder="Correo de contacto" value="">
                    </div>
                    <div class="mb-2">
                        <label for="Nombre"></label>
                        <input class="form-control rounded-start border border-success" required type="number" name="price" placeholder="Precio del Producto" value="">
                    </div>
                    <div class="mb-2">
